class LevelManager{
    ...
    //Function to change current map
    ChangeMap(mapfile, mapname, players){
        ...
        //Assign this map to the current file then initialise map
        this.map = mapfile;
    ...
    InitialiseFiles(){
        //Load in assets that make up the map
        ...
        //Assign all of these assets to the container
