...
var config = {
    type: Phaser.WEBGL,
    //To fit in the middle of the screen
    width: 1000,
    height: 600,
    physics: {
        default: 'arcade',
    ...
    //Locate and use the canvas available in the html web page
...
//Basic npcs
let player1, player2, cursors, npc2, npc3;

//NPC and player containers
let npc = [];
let players = [];
...
function InitMainMap(){
    ...
    //Initialise map as an NPC object
    InitNPC('mainmap');
}
...
//Generate map depending on map value
//Including map environment, NPCs complete with chat options and shops
function InitNPC(map){
    switch(map){
        ...
        case 'mainmap':{
            ...
            npc[2].enemies = playerColliders;
            npc[3].enemies = playerColliders;
            npc[4].enemies = playerColliders;
            npc[5].enemies = playerColliders;            npc[7].enemies = playerColliders;
            npc[6].enemies = playerColliders;
